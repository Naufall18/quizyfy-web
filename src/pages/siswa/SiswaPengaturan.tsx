...
export function SiswaPengaturan() {
    ...
    <div className="space-y-8 max-w-2xl">
      ...
      <Card className="flex items-center gap-5">
        ...
        <div>
          ...
          <span className="mt-1 inline-block rounded-full bg-primary-soft px-2.5 py-0.5 text-xs font-bold text-primary capitalize">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="h-11 w-full rounded-xl border border-line-strong bg-bg px-4 pr-11 text-sm text-ink focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/30"
              />
              <button
                type="button"
